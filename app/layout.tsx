...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_IN',
    type: 'website',
    images: [{ url: '/assets/images/social/premium-website-social-preview.svg', width: 1200, height: 630, alt: `${site.name} social preview` }],
  },
  twitter: { card: 'summary_large_image', title: `${site.name} | ${site.descriptor}`, description: site.tagline, images: ['/assets/images/social/premium-website-social-preview.svg'] },
