...
export function FloatingWhatsApp() {
  ...
  const className = 'fixed bottom-5 right-5 z-50 inline-flex items-center gap-3 rounded-full border border-[#1f8f53]/30 bg-[#0b7a3b] px-5 py-3 text-sm font-bold text-white shadow-2xl shadow-[#061724]/20 transition hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-[#d0ad68]/35';
