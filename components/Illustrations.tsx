export function LedgerIllustration() {
  return (
    <svg viewBox="0 0 640 520" className="h-auto w-full" role="img" aria-label="Abstract ledger and compliance dashboard illustration">
      <defs>
        <linearGradient id="goldGradient" x1="0" x2="1" y1="0" y2="1"><stop stopColor="#f2d58b" /><stop offset="1" stopColor="#b99655" /></linearGradient>
        <linearGradient id="navyGradient" x1="0" x2="1" y1="0" y2="1"><stop stopColor="#0e3144" /><stop offset="1" stopColor="#061724" /></linearGradient>
      </defs>
      <rect width="640" height="520" rx="42" fill="url(#navyGradient)" />
      <circle cx="516" cy="96" r="118" fill="#d0ad68" opacity=".14" />
      <rect x="72" y="86" width="330" height="348" rx="26" fill="#fff" opacity=".96" />
      <rect x="112" y="132" width="164" height="16" rx="8" fill="#061724" opacity=".82" />
      ...
      <rect x="232" y="318" width="110" height="56" rx="14" fill="#061724" opacity=".9" />
...
export function MonogramMark() {
  return (
    <svg viewBox="0 0 96 96" className="h-12 w-12" aria-hidden="true"><rect width="96" height="96" rx="24" fill="#061724" /><path fill="#d0ad68" d="M20 64V32h11l17 20 17-20h11v32H64V49L52 64h-8L32 49v15H20Z" /></svg>
  );
}
